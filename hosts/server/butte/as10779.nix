...
in
{
  ...
  networking.vxlans.vx0 = {
    vni = 18775;
    local = lib.blueprint.hosts.butte.ipv6;
    remote = "2a11:6c7:2::1";
    port = 4789;
    address = [ "2a11:6c7:f00:19d::2/64" ];
  };
  ...
  services.as10779 = {
    ...
    local = {
      ...
      ipv6.addresses = [
        "2620:be:a000::23:161:104:132/128" # unicast, offboard soon
        "2620:be:a000::23:161:104:17/128" # personal site anycast, offboard soon
        "2602:f590:0::23:161:104:132/128" # unicast
    ...
    router = {
      ...
      sessions = [
        ...
        }
        {
          ...
          mp = "v4 over v6";
          source = { ipv4 = null; ipv6 = "2a11:6c7:f00:19d::2"; };
          neighbor = {
            asn = 212895;
            ipv4 = null;
            ipv6 = "2a11:6c7:f00:19d::1";
          };
          import = {
            ipv4 = "import filter ${cfg.router.rpki.ipv4.filter};";
            ipv6 = "import filter ${cfg.router.rpki.ipv6.filter};";
